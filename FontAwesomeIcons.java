...
public enum FontAwesomeIcons {
    ...
    private FontAwesomeScale scale = FontAwesomeScale.EXTRA_SMALL;
    public final static String FONT_AWESOME_GLOBAL_CLASS = "fa";

    private FontAwesomeIcons(String cssClass) {
        this.cssClass = cssClass;
    }

    /**
     * Return the full css class, of an Icon and his scale
     * 
     * @return full icon class as string
     */
    public String css() {
        return String.format("%s %s %s", FONT_AWESOME_GLOBAL_CLASS, this.cssClass, scale.css());
    }

    public FontAwesomeIcons withScale(FontAwesomeScale scale) {
        this.scale = scale;
        return this;
    }

    /**
     * {@link FontAwesomeScale} modify the scale of a {@link FontAwesomeIcons}
     * 
     * @author mborn
     *
     */
    public enum FontAwesomeScale {
        EXTRA_SMALL("fa-lg"), SMALL("fa-2x"), MEDIUM("fa-3x"), LARGE("fa-4x"), EXTRA_LARGE("fa-5x");

        private String cssClass;

        private FontAwesomeScale(String cssClass) {
            this.cssClass = cssClass;
        }

        /**
         * Return css class of scale
         * 
         * @return
         */
        public String css() {
